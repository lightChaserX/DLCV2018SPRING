...
## 2-2
g_loss = pd.read_csv('GAN_gloss.csv')
d_loss = pd.read_csv('GAN_dloss.csv')
...
real_acc = pd.read_csv('GAN_real_im_scores.csv')
fake_acc = pd.read_csv('GAN_fake_im_scores.csv')
gene_acc = pd.read_csv('GAN_generator_scores.csv')
plt.subplot(1,2,2)
